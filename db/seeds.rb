...
@coupon_4 = Coupon.create!(name: "Discount of 50", code: "Discount50", discount_amount: 50, discount_type: 0, status: 1, merchant_id: 1)
@coupon_5 = Coupon.create!(name: "Discount of 35", code: "Discount35", discount_amount: 35, discount_type: 0, status: 1, merchant_id: 1)
@coupon_6 = Coupon.create!(name: "Discount of 45", code: "Discount45", discount_amount: 45, discount_type: 0, status: 1, merchant_id: 1)
